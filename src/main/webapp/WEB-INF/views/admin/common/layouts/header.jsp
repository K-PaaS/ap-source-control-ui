...
<div id="header">
    <div class="head_inner">
        <h1><a title="Application Platform 형상관리" href="/admin/serviceInstantList"><img alt="Application Platform 형상관리" src="/resources/images/logo.png"><span>형상관리</span></a></h1>
            <ul class="nav_ibtn">
                <li><a href="#" class="wintoggle">${name}님<b class="nav_arrow"></b></a>
