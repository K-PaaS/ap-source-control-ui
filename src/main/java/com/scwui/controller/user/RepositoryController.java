...
import com.scwui.common.util.Constants;
...
public class RepositoryController extends CommonController {
    ...
    * */
    ...
    public ModelAndView getRepositoryUpdate(@PathVariable("id") String id,
        ...
        com.scwui.model.Repository repository1 = convertObject(repository);
    ...
    public Map repositoryListForUserMore(HttpServletRequest request) {
        ...
        List<com.scwui.model.Repository> modelRepository = new ArrayList<>();
    ...
    public Map repositoryBrowse(@PathVariable("repositoryId") String repositoryId,
        ...
        Map map = new HashMap();
        //파일 List
        com.scwui.model.BrowserResult browserResult = repositoryService.getBrowseByParam(repositoryId, disableLastCommit, disableSubRepositoryDetection, path, recursive, revision);
    ...
    private com.scwui.model.Repository convertObject(Object requestRepository){
        String jsonStr = null;
        com.scwui.model.Repository repository = null;
        ...
        try {
            repository = objectMapper.readValue(jsonStr, com.scwui.model.Repository.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return repository;
