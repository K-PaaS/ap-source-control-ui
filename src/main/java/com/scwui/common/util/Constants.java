...
public class Constants {
    ...
    public static final String RESULT_STATUS_CANCELED = "CANCELED";
    ...
    public static final String CHECK_YN_Y = "ROLE_CREATE_Y";
    public static final String CHECK_YN_N = "ROLE_CREATE_N";
    ...
    public static final String ROLE_OWNER = "ADMIN";
    public static final String ROLE_WRITE = "WRITE";
    public static final String ROLE_READ = "READ";

    public static final String PRPOERTIE_INSTANCE_ID = "instance_id";
    public static final String PRPOERTIE_CREATE_USER = "create_user";
