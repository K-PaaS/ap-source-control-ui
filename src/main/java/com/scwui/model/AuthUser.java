...
public class AuthUser implements UserDetails, CredentialsContainer {
     ...
     */
    public AuthUser(String name, Collection<? extends GrantedAuthority> authorities) {
        this(name, true, true, true, true, authorities);
    }
    /**
     ...
     */
    public AuthUser(String username, boolean enabled, boolean accountNonExpired,
